      ...
      <div className="max-w-xl space-y-5">
        ...
        >
          <p className="text-foreground text-sm leading-relaxed">
            ...
            production applications including CRM widgets, real-time systems,
            and voice platforms.
          </p>

          <p className="text-muted-foreground text-sm leading-relaxed">
            Experienced in improving large legacy codebases, building scalable
            UI systems, and shipping frontend and backend features used in live
            products.
          </p>
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-start gap-2">
              ...
              Modernized and refactored legacy applications with large
            ...
            <li className="flex items-start gap-2">
              <span className="bg-primary mt-1 size-1.5 rounded-full" />
              Worked across frontend, backend, testing, and production
              maintenance
            </li>
          </ul>
        </motion.div>
